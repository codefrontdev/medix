...
export class AuthInfoController {
  ...
  public async profile(
    ...
    const result =
      await this
        .queryBus
        .execute<UsersGetQuery, AppResult<UsersInfoResult>>(
          query,
        );

    const response =
      AppResponse
        .create<UsersInfoResponse>(
          result.isSuccess,
          result.key,
          result.message,
          result.data,
  ...
  public async update(
    ...
    const result =
      await this
        .commandBus
        .execute<AuthInfoUpdateCommand, AppResult<UsersInfoResult>>(
          command,
        );
  ...
  public async changePassword(
    ...
    const command =
      new AuthInfoChangePasswordCommand(
        req.user.userId,
    ...
    const result =
      await this
        .commandBus
        .execute<AuthInfoChangePasswordCommand, AppResult<AuthTokensResponse>>(
          command,
        );

    const response =
      AppResponse
        .create<AuthTokensResponse>(
          result.isSuccess,
          result.key,
          result.message,
          result.data,
  ...
  public async logout(
    ...
    const result =
      await this
        .commandBus
        .execute<AuthInfoLogoutCommand, AppResult<AppResult<null>>>(
          command,
        );

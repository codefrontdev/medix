...
import { TenderQuotationsGetAllQueryj2 } from './tender-quotations-get-all-J2.query';

@QueryHandler(TenderQuotationsGetAllQueryj2)
export class TenderQuotationsGetAllHandlerj2
  implements IQueryHandler<TenderQuotationsGetAllQueryj2, AppResult<Array<TenderQuotationsGetAllResult>>> {
  ...
  public async execute(
    query: TenderQuotationsGetAllQueryj2,

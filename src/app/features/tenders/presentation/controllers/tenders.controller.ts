...
export class TendersController {
  ...
  public async upsert(
    ...
    const result = await this.commandBus.execute<
      TendersUpsertCommand,
      AppResult<TendersGetResult>
    >(command);

    return AppResponse.create<TendersGetResponse>(
      result.isSuccess,
      result.key,
      result.message,
      result.data,
  ...
  public async delete(
    ...
    const command = new TendersDeleteCommand(tendersDeleteRequest.id, userId);

    const result = await this.commandBus.execute<
      TendersDeleteCommand,
      AppResult<null>
    >(command);
  ...
  public async get(
    ...
    const query = new TendersGetQuery(tendersGetRequest.id);
  ...
  public async getAll(
    ...
    return AppResponse.create<Array<TendersGetAllResponse>>(
      result.isSuccess,
      result.key,
      result.message,
      responseData,
  ...
  public async getAllTotal(@Req() req: any): Promise<{ total: number }> {
    ...
    const openedTenders = await this.queryBus.execute<
      TendersGetAllQuery,
      AppResult<Array<TendersGetAllResult>>
    >(query);
  ...
  public async getAllTotalByStatus(
    ...
    const Tenders = await this.queryBus.execute<
      TendersGetAllQuery,
      AppResult<Array<TendersGetAllResult>>
    >(query);

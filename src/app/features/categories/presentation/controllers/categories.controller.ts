...
export class CategoriesController {
  ...
  public async upsert(
    ...
    const command = new CategoriesUpsertCommand(
    ...
    const result = await this.commandBus.execute<
      CategoriesUpsertCommand,
      AppResult<CategoriesGetResult>
    >(command);

    const response = AppResponse.create<CategoriesGetResponse>(
      result.isSuccess,
      result.key,
      result.message,
      result.data,
  ...
  public async delete(
    ...
    const command = new CategoriesDeleteCommand(categoriesDeleteRequest.id);
  ...
  public async get(
    ...
    const query = new CategoriesGetQuery(categoriesGetRequest.id);
  ...
  public async getAll(
    ...
    const query = new CategoriesGetAllQuery(
    ...
    const result = await this.queryBus.execute<
      CategoriesGetAllQuery,
      AppResult<Array<CategoriesGetAllResult>>
    >(query);

    const response = AppResponse.create<Array<CategoriesGetAllResponse>>(
      result.isSuccess,
      result.key,
      result.message,
      result.data,

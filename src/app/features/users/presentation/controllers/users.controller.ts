...
export class UsersController {
  ...
  public async upsert(
    ...
    const command = new UsersUpsertCommand(
    ...
    const response = AppResponse.create<UsersGetResponse>(
      result.isSuccess,
      result.key,
      result.message,
      result.data,
  ...
  public async verify(
    ...
    const command = new UsersVerifyCommand(
  ...
  public async delete(
    ...
    const command = new UsersDeleteCommand(usersDeleteRequest.id);
  ...
  public async get(
    ...
    const query = new UsersGetQuery(usersGetRequest.id);
  ...
  public async getAll(
    ...
    const query = new UsersGetAllQuery(
    ...
    const result = await this.queryBus.execute<
      UsersGetAllQuery,
      AppResult<Array<UsersGetAllResponse>>
    >(query);

    const response = AppResponse.create<Array<UsersGetAllResponse>>(
      result.isSuccess,
      result.key,
      result.message,
      result.data,
